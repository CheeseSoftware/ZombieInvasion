...
public class EntityFastZombie extends EntityZombie
{
	...
	public EntityFastZombie(World world)
	{
		...
		try
		{
			...
			e.setValue(512); // Navigation distance in block lengths goes here
		}
		catch (Exception ex)
		{
		}
		...
		this.targetSelector.a(2, new CustomPathfinderGoalNearestAttackableTarget(this, EntityVillager.class, 0, false));
		this.a(0.6F, 1.8F);
	}
